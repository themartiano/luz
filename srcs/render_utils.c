...
/*   Updated: 2021/04/22 10:55:43 by ejuliao-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	gen_pixel_clr(t_holder *holder, t_ray ray, t_color *hit_color, float t)
{
	...
	set_color(hit_color,
		((float)hit_color->r - t) + ((float)holder->scene.amb_light.color.r * holder->scene.amb_light.brightness),
		((float)hit_color->g - t) + ((float)holder->scene.amb_light.color.g * holder->scene.amb_light.brightness),
		((float)hit_color->b - t) + ((float)holder->scene.amb_light.color.b * holder->scene.amb_light.brightness));
}
