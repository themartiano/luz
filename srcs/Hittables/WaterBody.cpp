...
WaterBody::WaterBody(Vector3 position, double size, Color color, unsigned int subSamples, double noiseScale, double magnitude, double depth, unsigned int seed)
{
