...
BENCH_CASES ?= default many-objects mesh-bvh diffuse postprocess atmosphere lights emissive-geometry primitives-materials volumes obj-mesh stormtroopers-preview stormtroopers-adaptive-tuned stormtroopers-denoise-micro
BENCH_WIDTH ?=
BENCH_HEIGHT ?=
BENCH_SAMPLES ?=
BENCH_BOUNCES ?=
